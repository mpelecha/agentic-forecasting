"""Main-verifier-cleaned active research pipeline for CFM Agent v5.2."""
...
from energy_oil_forecasting.cfm_agent_v_5_2.source_registry import (
    normalize_domain,
...
class ResearchPipelineTool:
    ...
    def __init__(self, settings: CfmV52Settings, *, search_model: str) -> None:
