...
from energy_oil_forecasting.cfm_agent_v_5_2.schemas import ActiveSource
...
async def test_pipeline_returns_only_cleaned_summaries(monkeypatch):
    tool = ResearchPipelineTool(CfmV52Settings(), search_model="test")
    ...
    monkeypatch.setattr(
        "energy_oil_forecasting.cfm_agent_v_5_2.tools.research_pipeline._verify_no_leakage",
        fake_verify,
    )
