...
LABELS: dict[str, str] = {
    ...
    "ecm_regression_logtgt_expanded_yh2_levelonly": "ECM exp2 lvl-only logtgt",
    "ecm_regression_expanded_yh2_levelonly": "ECM expanded2 lvl-only",
    "ecm_regression_expanded_yh2": "ECM expanded2 (+Brent)",
    ...
    "ecm_regression_difflast": "ECM (diff-path=last)",
