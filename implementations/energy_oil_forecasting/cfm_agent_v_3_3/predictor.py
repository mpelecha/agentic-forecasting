"""Policy-controlled predictor for CFM Agent v3.3."""
...
from energy_oil_forecasting.cfm_agent_v_3_3.prompts import CfmV33PromptBuilder
from energy_oil_forecasting.cfm_agent_v_3_3.sanitizer import sanitize_assessment
from energy_oil_forecasting.cfm_agent_v_3_3.schemas import ModelForecastResult, PolicyDecision
from energy_oil_forecasting.cfm_agent_v_3_3.tools import AuthoritativeSuiteTool


class CfmV33Predictor(Predictor):
    ...
    def __init__(
        ...
        self._inner = AgentPredictor(
            agent_config=config,
            prompt_builder=CfmV33PromptBuilder(),
    ...
    def predict(self, task: ForecastingTask, context: ForecastContext) -> list[Prediction]:
        ...
        if result is None or result.model_suite is None or result.model_suite.ensemble is None:
            raise RuntimeError("CFM v3.3 requires one successful authoritative numerical-suite result.")
