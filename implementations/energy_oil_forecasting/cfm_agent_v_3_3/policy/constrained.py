"""Graduated, bounded, auditable transformation policy for CFM Agent v3.3."""
...
from energy_oil_forecasting.cfm_agent_v_3_3.schemas import ModelHorizonForecast, PolicyDecision
...
class ConstrainedActionPolicy:
    ...
    def __init__(self, settings: CfmV33Settings) -> None:
    ...
    def apply(
        ...
        *,
        ...
        elif requested_uncertainty > 1.0:
            uncertainty_multiplier = min(requested_uncertainty, tier_uncertainty_cap)
        elif requested_uncertainty < 1.0 and tier == 3:
            uncertainty_multiplier = requested_uncertainty
        else:
            uncertainty_multiplier = 1.0
