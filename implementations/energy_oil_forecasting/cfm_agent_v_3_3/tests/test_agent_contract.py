...
from energy_oil_forecasting.cfm_agent_v_3_3 import (
    AGENT_NAME,
    DEFAULT_SETTINGS,
...
def test_default_sample_count_and_agent_composition(synthetic_service) -> None:
    ...
    assert config.name == AGENT_NAME == "cfm_agent_v_3_3"
...
def test_prompt_forbids_llm_authored_final_numbers(synthetic_service) -> None:
    ...
    payload = json.loads(CfmV33PromptBuilder()(task=task, context=synthetic_service.context(datetime(2021, 6, 1))))
