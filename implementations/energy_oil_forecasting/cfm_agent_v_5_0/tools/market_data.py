...
from energy_oil_forecasting.cfm_agent_v_5_0.diagnostics import (
    compute_market_diagnostics,
)
from energy_oil_forecasting.cfm_agent_v_5_0.fingerprints import stable_fingerprint
from energy_oil_forecasting.cfm_agent_v_5_0.models import (
    ...
    def _run_model_suite(
        ...
        *,
        ...
        task = ForecastingTask(
            task_id=f"cfm_v5_0_{target_series_id}_{cutoff_date}",
            target_series_id=target_series_id,
            horizons=horizons,
            frequency=frequency,
            description=f"CFM v5.0 authoritative numerical suite for {target_series_id}.",
        )
