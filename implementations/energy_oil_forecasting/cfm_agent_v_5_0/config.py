"""Configuration for the self-contained CFM Agent v5.0 package."""
...
class CfmV50Settings(BaseModel):
    ...
    claim_support_verifier_model: str = "gemini-3.5-flash"
...
DEFAULT_SETTINGS = CfmV50Settings()
__all__ = [
    "AGENT_NAME",
    "PACKAGE_ROOT",
    "SKILLS_ROOT",
